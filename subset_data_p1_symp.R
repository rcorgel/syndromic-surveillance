...
#                                                                              #
# Purpose:   Subset Influenza, COVID-19, and RSV medical claims data. Only     #
#            include symptomatic cases.                                        #
# Steps:                                                                       # 
#            1. Set-up script                                                  #
...
# Load processed data
flu <- readRDS('./tmp/flu_p1_dat_proc_symp.rds')
...
flu <- flu |> filter(symp_count > 1)

# Determine the minimum number of cases to sample from by month
month_cases <- flu |>
  filter(flu == 1) |> group_by(month, year) |>
  mutate(sum = sum(patient_count_imp)) |>
  distinct(year, month, sum)
...
cases_exp_sub_16_17 <- cases_16_17 |> group_by(month) |> uncount(patient_count_imp) |> 
  sample_n(3000)
cases_exp_sub_17_18 <- cases_17_18 |> group_by(month) |> uncount(patient_count_imp) |> 
  sample_n(3000)
cases_exp_sub_18_19 <- cases_18_19 |> group_by(month) |> uncount(patient_count_imp) |> 
  sample_n(3000)
cases_exp_sub_19_20 <- cases_19_20 |> group_by(month) |> uncount(patient_count_imp) |> 
  sample_n(3000)

# Save expanded case data
saveRDS(cases_exp_sub_16_17, './tmp/cases_exp_sub_16_17_flu_symp_2.rds') 
saveRDS(cases_exp_sub_17_18, './tmp/cases_exp_sub_17_18_flu_symp_2.rds') 
saveRDS(cases_exp_sub_18_19, './tmp/cases_exp_sub_18_19_flu_symp_2.rds') 
saveRDS(cases_exp_sub_19_20, './tmp/cases_exp_sub_19_20_flu_symp_2.rds') 
...
non_cases_exp_sub_16_17 <- non_cases_16_17 |> group_by(month) |> uncount(patient_count_imp) |> 
  sample_n(3000)
non_cases_exp_sub_17_18 <- non_cases_17_18 |> group_by(month) |> uncount(patient_count_imp) |> 
                           sample_n(3000)
non_cases_exp_sub_18_19 <- non_cases_18_19 |> group_by(month) |> uncount(patient_count_imp) |> 
                           sample_n(3000)
non_cases_exp_sub_19_20 <- non_cases_19_20 |> group_by(month) |> uncount(patient_count_imp) |> 
                           sample_n(3000)

# Save expanded non-case data
saveRDS(non_cases_exp_sub_16_17, './tmp/non_cases_exp_sub_16_17_flu_symp_2.rds') 
saveRDS(non_cases_exp_sub_17_18, './tmp/non_cases_exp_sub_17_18_flu_symp_2.rds') 
saveRDS(non_cases_exp_sub_18_19, './tmp/non_cases_exp_sub_18_19_flu_symp_2.rds') 
saveRDS(non_cases_exp_sub_19_20, './tmp/non_cases_exp_sub_19_20_flu_symp_2.rds') 
rm(list = ls())
...
# Remove asymptomatic cases for disease and non-diseased
covid <- covid |> filter(symp_count > 0)
...
# Save expanded case data
saveRDS(cases_exp_sub_wild, './tmp/cases_exp_sub_wild_covid_symp.rds') 
saveRDS(cases_exp_sub_alpha, './tmp/cases_exp_sub_alpha_covid_symp.rds') 
saveRDS(cases_exp_sub_delta, './tmp/cases_exp_sub_delta_covid_symp.rds') 
saveRDS(cases_exp_sub_omicron, './tmp/cases_exp_sub_omicron_covid_symp.rds') 
...
# Save expanded non-case data
saveRDS(non_cases_exp_sub_wild, './tmp/non_cases_exp_sub_wild_covid_symp.rds') 
saveRDS(non_cases_exp_sub_alpha, './tmp/non_cases_exp_sub_alpha_covid_symp.rds') 
saveRDS(non_cases_exp_sub_delta, './tmp/non_cases_exp_sub_delta_covid_symp.rds') 
saveRDS(non_cases_exp_sub_omicron, './tmp/non_cases_exp_sub_omicron_covid_symp.rds') 
rm(list = ls())
...
# Save expanded case data
saveRDS(cases_exp_sub_16_17, './tmp/cases_exp_sub_16_17_rsv_symp.rds') 
saveRDS(cases_exp_sub_17_18, './tmp/cases_exp_sub_17_18_rsv_symp.rds') 
saveRDS(cases_exp_sub_18_19, './tmp/cases_exp_sub_18_19_rsv_symp.rds') 
saveRDS(cases_exp_sub_19_20, './tmp/cases_exp_sub_19_20_rsv_symp.rds') 
remove(cases_16_17, cases_17_18, cases_18_19, cases_19_20, 
       cases_exp_sub_16_17, cases_exp_sub_17_18, cases_exp_sub_18_19, cases_exp_sub_19_20)
...
# Save expanded non-case data
saveRDS(non_cases_exp_sub_16_17, './tmp/non_cases_exp_sub_16_17_rsv_symp.rds') 
saveRDS(non_cases_exp_sub_17_18, './tmp/non_cases_exp_sub_17_18_rsv_symp.rds') 
saveRDS(non_cases_exp_sub_18_19, './tmp/non_cases_exp_sub_18_19_rsv_symp.rds') 
saveRDS(non_cases_exp_sub_19_20, './tmp/non_cases_exp_sub_19_20_rsv_symp.rds') 
rm(list = ls())
