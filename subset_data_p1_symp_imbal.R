...
cases_exp_sub_16_17 <- flu_16_17 |> group_by(month) |> uncount(patient_count_imp) |> 
  sample_n(100000)
cases_exp_sub_17_18 <- flu_17_18 |> group_by(month) |> uncount(patient_count_imp) |> 
  sample_n(100000)
cases_exp_sub_18_19 <- flu_18_19 |> group_by(month) |> uncount(patient_count_imp) |> 
  sample_n(100000)
cases_exp_sub_19_20 <- flu_19_20 |> group_by(month) |> uncount(patient_count_imp) |> 
  sample_n(100000)

# Save expanded case data
saveRDS(cases_exp_sub_16_17, './tmp/flu_exp_sub_16_17_flu_symp.rds') 
saveRDS(cases_exp_sub_17_18, './tmp/flu_exp_sub_17_18_flu_symp.rds') 
saveRDS(cases_exp_sub_18_19, './tmp/flu_exp_sub_18_19_flu_symp.rds') 
saveRDS(cases_exp_sub_19_20, './tmp/flu_exp_sub_19_20_flu_symp.rds') 
...
saveRDS(non_cases_exp_sub_16_17, './tmp/non_cases_exp_sub_16_17_flu_symp.rds') 
saveRDS(non_cases_exp_sub_17_18, './tmp/non_cases_exp_sub_17_18_flu_symp.rds') 
saveRDS(non_cases_exp_sub_18_19, './tmp/non_cases_exp_sub_18_19_flu_symp.rds') 
saveRDS(non_cases_exp_sub_19_20, './tmp/non_cases_exp_sub_19_20_flu_symp.rds') 
rm(list = ls())
